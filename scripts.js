...
async function fetchNetworkStats() {
    try {
        const response = await fetch("https://p2pool.oieieio.net/api/network/stats");
...
async function fetchPoolStats() {
    try {
        const [poolStatsRes, poolBlocksRes, networkStatsRes] = await Promise.all([
            fetch("https://p2pool.oieieio.net/api/pool/stats"),
            fetch("https://p2pool.oieieio.net/api/pool/blocks"),
            fetch("https://p2pool.oieieio.net/api/network/stats"),
        ]);
...
async function fetchP2PStats() {
    try {
        const response = await fetch("https://p2pool.oieieio.net/api/local/p2p");
...
async function getCountryFromIP(ipWithPort) {
    const ip = ipWithPort.split(":")[0]; // Extract the IP
    try {
        const response = await fetch(`geopip.php?ip=${ip}`);
        const data = await response.json();
        if (data.country) {
            return data.country; // Return the resolved country name
        } else {
            return "Unknown";
        }
    } catch (error) {
...
async function fetchMinerStats() {
    try {
        const response = await fetch("https://p2pool.oieieio.net/api/local/miner");
...
async function fetchStratumStats() {
    try {
        const response = await fetch("https://p2pool.oieieio.net/api/local/stratum");
        if (!response.ok) {
...
async function fetchBlocks() {
    try {
        const response = await fetch("https://p2pool.oieieio.net/api/pool/blocks");
